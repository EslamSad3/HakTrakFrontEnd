...
function CreateIps() {
  const { addNewIp, isLoading } = useContext(Context);
  ...
  async function hanldeAddNewIp(values) {
    await addNewIp(values);
  }
  ...
  return (
    ...
    >
      <Header title={ "Add New Ip" }></Header>
