...
function CreateMitreAttack() {
  const { addNewMitreAttack, isLoading } = useContext(Context);

  const validationSchema = Yup.object().shape({
    incidentId: Yup.string().required("incident Id Required"),
    tactic: Yup.string().required("tactic Required"),
    technique: Yup.string().required("technique Required"),
  ...
  async function hanldeaddNewMitreAttack(values) {
    await addNewMitreAttack(values);
  }
  ...
  let formik = useFormik({
    ...
    validationSchema,
    onSubmit: hanldeaddNewMitreAttack,
  });
      ...
      <form onSubmit={formik.handleSubmit}>
        <FormControl>
          ...
          <TextField
            ...
            id="tactic"
          />
          {formik.errors.tactic && formik.touched.tactic ? (
            <Alert severity="error"> {formik.errors.tactic}</Alert>
          ) : null}
          ...
          {formik.errors.technique && formik.touched.technique ? (
            <Alert severity="error"> {formik.errors.technique}</Alert>
          ) : null}
          {/* description */}
          <TextField
            margin="normal"
...
export default CreateMitreAttack;
